...
{
    public class BolsterDiceEffectResolution : EffectResolution
    {
    ...
    public class BolsterDiceEffect : DiceEffectLogic<BolsterDiceEffectResolution>
    {
        ...
        protected override async Task Animate(EffectAnimateContext ctx, BolsterDiceEffectResolution resolution, int sourceInstanceId, CancellationToken ct)
        {
