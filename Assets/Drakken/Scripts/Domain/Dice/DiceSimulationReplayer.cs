    ...
    public class DiceSimulationReplayer
    {
            ...
            ScenePlayerObjects existingViews = null)
        {
            ...
            while (elapsedSeconds < maxTimeSeconds)
            {
                ...
                nextEffectIndex = DispatchEffects(trace, existingViews, liveViews, nextEffectIndex, rawTick, effectTasks, ct);
            ...
            if (!ct.IsCancellationRequested)
            {
                ...
                DispatchEffects(trace, existingViews, liveViews, nextEffectIndex, finalTick, effectTasks, ct);
            }
            ...
            CancellationToken ct)
        {
            ...
            while (nextEffectIndex < trace.EffectEvents.Count && rawTick >= trace.EffectEvents[nextEffectIndex].Tick)
            {
                ...
                if (effect != null)
                {
                    effectTasks.Add(effect.Animate(animateCtx, occurrence.Resolution, occurrence.SourceInstanceId, ct));
                }
