...
namespace Drakken.Networking
{
    public interface IGameConnection
    {
        ...
        void Server_BroadcastMatchStartDraftingPhase(ulong[] clientIds, GameState gameState, MatchDiceTraces diceTraces);
        ...
        void Server_BroadcastMatchNextRound(ulong[] clientIds, GameState gameState, MatchDiceTraces diceTraces);
    }
}